...
CBAD_JAR = 'TranskribusBaseLineEvaluationScheme-0.1.3-jar-with-dependencies.jar'
...
def eval_fn(input_dir: str,
    ...
    :param input_dir: predicted XML files directory
    ...
    xml_pred_filenames_list = glob(os.path.join(input_dir, '*.xml'))
...
if __name__ == '__main__':
    eval_fn("../../demo/baseline_extraction_output", "../../data/cbad-masks/complex/test/gt", "evaluation_output")